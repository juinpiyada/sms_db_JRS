...
const CollegeGroupManager = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      setGroups(gs => gs.filter(x => x.groupid !== id));
    ...
    <div className="mu-page">
      ...
      <div className="mu-toolbar">
        <label className="searchbox" aria-label="Search groups">
          <span className="searchbox__icon" aria-hidden="true">
            {/* SVG magnifier to match the Colleges page look */}
      ...
      <div className="mu-tablewrap-outer">
        <div className="mu-tablewrap">
          ...
          {/* Make scrollbar sit ABOVE pagination (wrap table in its own scroll area) */}
          <div className="mu-tablecard" style={{ overflow: 'visible' }}>
                    ...
                    pageItems.map(g => (
                      <tr key={g.groupid}>
                        ...
                        <td className="mu-td">
                          ...
                          <button className="btn btn--danger" onClick={() => handleDelete(g.groupid)}>Delete</button>
                        </td>
                      </tr>
                    ))
                  )}
            ...
            {/* Screenshot-style pagination (stays at bottom, scrollbar is above) */}
